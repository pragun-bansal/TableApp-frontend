  ...
  return (
    <div className="container mx-auto p-4">
            ...
            <>
              {update == item._id ? (
                ...
                <tr key={item._id}>
                  ...
                  <td className="p-2 border-b text-center">{item.name}</td>
                  <td className="p-2 border-b text-center">{item.phone_number}</td>
                  <td className="p-2 border-b text-center">{item.email}</td>
                  <td className="p-2 border-b text-center">{item.hobby}</td>
      ...
      <div className="flex justify-end mt-4">
        ...
        <button className="bg-red-500 text-white rounded p-4" onClick={handleDelete}>
          Delete
        </button>
      </div>
    </div>
